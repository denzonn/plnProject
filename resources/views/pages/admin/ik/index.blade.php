...
@section('title')
    Dashboard - Instruksi Kerja
@endsection

@section('content')
    <div class="bg-white p-8 rounded-md text-gray-500">
        <a href="{{ route('create-ik') }}" class="px-6 py-3 bg-primary rounded-md text-white">
            Tambah IK
        </a>
        <div class="pt-4">
            <table id="ikTable" class="w-full">
            ...
            <form id="deleteForm" action="{{ route('ik.delete-selected') }}" method="POST" class="hidden">
                @csrf
                @method('DELETE')
            ...
            $('#ikTable').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        data: 'id',
                        render: function(data) {
                            let editUrl = '{{ route('edit-ik', ':id') }}';
                            let deleteUrl = '{{ route('delete-ik', ':id') }}';
